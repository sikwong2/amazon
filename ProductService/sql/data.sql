...
-- PRODUCTS TABLE
  ...
  INSERT INTO product(id, data) VALUES ('6a2212e5-af0b-4472-a724-537bdc6c571c', jsonb_build_object(
    ...
    'category', ARRAY['movie', 'dvd', 'shrek']
  ));
  ...
  INSERT INTO product(id, data) VALUES ('86b0b448-fa22-4235-a88f-211e7619d44b', jsonb_build_object(
    ...
    'category', ARRAY['sports', 'sale', 'basketball']
  ));
  INSERT INTO product(id, data) VALUES ('c5f199c9-0799-43ad-848b-f7e8e76ee0e4', jsonb_build_object(
    ...
    'category', ARRAY['basketball', 'sale', 'sports']
  ));
  INSERT INTO product(id, data) VALUES ('c85ddd6d-c3ef-4ba2-8951-a6f377c4fe94', jsonb_build_object(
    ...
    'category', ARRAY['Spalding', 'basketball', 'sale', 'sports']
  ));
  INSERT INTO product(id, data) VALUES ('443c7147-9747-4f94-bc49-4dda3b7bfc59', jsonb_build_object(
    ...
    'category', ARRAY['Molten', 'basketball', 'sports', 'sale']
  ));
  ...
  INSERT INTO product(id, data) VALUES ('fcab207a-fd48-4e81-a15d-a754f49fcd15', jsonb_build_object(
    ...
    'category', ARRAY['lamp', 'sale', 'furniture', 'home']
  ));
  INSERT INTO product(id, data) VALUES ('460ee6d3-e911-4b39-87f8-d342831f2b28', jsonb_build_object(
    ...
    'category', ARRAY['furniture', 'sale', 'lamp', 'home']
  ));
  ...
  INSERT INTO product(id, data) VALUES ('2f804cfb-c81a-43e2-9e78-9160332e46bd', jsonb_build_object(
    ...
    'category', ARRAY['Women’s shoes', 'adidas', 'shoes', 'women’s clothes', 'clothing', 'women', 'shoes']
  ));
  INSERT INTO product(id, data) VALUES ('572d681e-c916-46f2-9754-896590d82f3a', jsonb_build_object(
    ...
    'category', ARRAY['Ultraboost', 'women’s shoes', 'women’s clothes', 'adidas', 'running shoe', 'clothing', 'shoes']
  ));
  INSERT INTO product(id, data) VALUES ('1c966d34-5079-4ead-82df-3aecc4b10d06', jsonb_build_object(
    ...
    'category', ARRAY['Hoodie', 'adidas', 'men’s fashion', 'men’s clothing', 'sale', 'clothing']
  ));
  INSERT INTO product(id, data) VALUES ('4f9920d3-b733-4ab0-a7ef-2581a8578325', jsonb_build_object(
    ...
    'category', ARRAY['Gym Drawstring Bags by Adidas', 'adidas', 'bags', 'drawstring bags', 'sports']
  ));
  ...
  INSERT INTO product(id, data) VALUES ('39432e80-2d72-4496-a6fd-bfb79f499956', jsonb_build_object(
    ...
    'category', ARRAY['Convertible Sectional Sofa Couch', 'couch', 'sofa', 'furniture', 'sale', 'home']
  ));
  INSERT INTO product(id, data) VALUES ('67714aeb-e478-4e41-ace2-b823c07f1798', jsonb_build_object(
    ...
    'category', ARRAY['Comfy Sofa Couch', 'sofa', 'couch', 'furniture', 'home']
  ));
  INSERT INTO product(id, data) VALUES ('cb20e870-9d2d-4a36-9338-91847dca1d9d', jsonb_build_object(
    ...
    'category', ARRAY['Futon Sofa Bed', 'sofa', 'couch', 'futon', 'home', 'bedroom', 'furniture']
  ));
  ...
  INSERT INTO product(id, data) VALUES ('be38c711-ddd8-4779-a93f-d77e82227187', jsonb_build_object(
    ...
    'category', ARRAY['Storage Cabinets by WEENFON', 'cabinet', 'storage', 'drawer', 'kitchen', 'bathroom', 'home', 'furniture', 'sale']
  ));
  INSERT INTO product(id, data) VALUES ('6b506670-603b-42e3-acea-6706dde5ff94', jsonb_build_object(
    ...
    'category', ARRAY['Floor Cabinets', 'cabinet', 'storage', 'drawer', 'bathroom', 'kitchen', 'home', 'furniture', 'sale']
  ));
  INSERT INTO product(id, data) VALUES ('315cd52a-4905-4c42-a0a7-0551a6bb69c3', jsonb_build_object(
    ...
    'category', ARRAY['Kitchen Storage', 'cabinet', 'storage', 'kitchen', 'furniture', 'home']
  ));
...
-- JUNCTION TABLE
  ...
  -- PESRAE Floor Lamp
    ...
    ('fcab207a-fd48-4e81-a15d-a754f49fcd15', (SELECT id FROM category WHERE name='home'));
  -- luckystyle Floor Lamp
    ...
    ('460ee6d3-e911-4b39-87f8-d342831f2b28', (SELECT id FROM category WHERE name='home'));
  ...
  -- Small Table Lamp for Bedroom
    INSERT INTO product_category (product_id, category_id) VALUES 
    ('09cc271a-0f26-45d1-a774-4443fc732a45', (SELECT id FROM category WHERE name='home')),
  ...
  -- SUNMORY Floor Lamp with Shelves
    ...
    ('e6c295cf-8037-40f7-b402-38db13bcef37', (SELECT id FROM category WHERE name = 'home')),
  ...
  -- LED Floor Lamp for Living Room
    ...
    ('da627ad0-e44c-42e3-8990-a94aa2303ee5', (SELECT id FROM category WHERE name = 'home')),
  ...
  -- Convertible Sectional Sofa Couch
    ...
    ('39432e80-2d72-4496-a6fd-bfb79f499956', (SELECT id FROM category WHERE name='home'));
  -- VanAcc 89 Inch Sofa
    INSERT INTO product_category (product_id, category_id) VALUES 
    ...
    ('67714aeb-e478-4e41-ace2-b823c07f1798', (SELECT id FROM category WHERE name='home'));
  -- Flamaker Futon Sofa Bed
    ...
    ('cb20e870-9d2d-4a36-9338-91847dca1d9d', (SELECT id FROM category WHERE name='home')),
  ...
  -- WEENFON Bathroom Cabinet
    ...
    ('be38c711-ddd8-4779-a93f-d77e82227187', (SELECT id FROM category WHERE name='home')),
  ...
  -- Yaheetech Wooden Floor Cabinet
    ...
    ('6b506670-603b-42e3-acea-6706dde5ff94', (SELECT id FROM category WHERE name='home')),
  ...
  ('315cd52a-4905-4c42-a0a7-0551a6bb69c3', (SELECT id FROM category WHERE name='home')),
