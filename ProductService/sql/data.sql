...
--   'name', '', 'price', 0, 'stock', 0, 'rating', 0.0, 
--   'image', ARRAY[''], 
--   'description', ARRAY[''], 
--   'category', ARRAY['']
-- ));
...
INSERT INTO product(data) VALUES (jsonb_build_object(
  ...
  'category', ARRAY['Women’s shoes', 'adidas', 'shoes', 'Women’s clothes', 'clothing', 'women', 'tennis shoe']
));
...
INSERT INTO product(data) VALUES (jsonb_build_object(
  ...
  'category', ARRAY['Ultraboost', 'women’s shoes', 'women’s clothes', 'adidas', 'Running Shoe', '']
));
INSERT INTO product(data) VALUES (jsonb_build_object(
  ...
  'category', ARRAY['Hoodie', 'adidas', 'men’s fashion', 'men’s clothing']
));
INSERT INTO product(data) VALUES (jsonb_build_object(
  ...
  'category', ARRAY['Gym Drawstring Bags by Adidas', 'adidas', 'bags', 'drawstring bags']
));
