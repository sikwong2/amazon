import { Path, Controller, Get, Response, Route, Delete } from 'tsoa';
...
export class OrdersController extends Controller {
  ...
  public async getByVendorId(@Path() Id: string): Promise<OrdersInfo[] | undefined> {
  ...
  @Get('shopper/{Id}')
  @Response('200', 'Successful')
  public async getByShopperId(@Path() Id: string): Promise<OrdersInfo[] | undefined> {
    return new OrdersService()
  ...
  @Delete('{orderId}')
  public async deleteOrder(@Path() orderId: string): Promise<OrdersInfo> {
